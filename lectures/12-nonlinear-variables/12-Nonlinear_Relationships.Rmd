...
.hi-pink[Analytical Problem Set 5] due Friday 5/13  
.hi-pink[Computational Problem Set 5] due Monday 5/16  
...
3. $\color{#EC7662}{Y_i = \beta_0 + \beta_1\beta_2X_{i} + u_i}$
...
**A.sub[2]:** Untrained workers `r abs(round((exp(-b2)-1)*100, 2))` percent less productive than trained workers.
...
$$\color{#EC7662}{\dfrac{\partial Y}{\partial X} = \beta_1 + 2 \beta_2 X}$$
...
.pink[What is the marginal effect of] $\color{#EC7662}{X}$ .pink[on] $\color{#EC7662}{Y}$.pink[?]
--
<br>
...
.pink[What is the marginal effect of] $\color{#EC7662}{X}$ .pink[on] $\color{#EC7662}{Y}$ .pink[when] $\color{#EC7662}{X=0}$.pink[?]
--
<br>
...
.pink[What is the marginal effect of] $\color{#EC7662}{X}$ .pink[on] $\color{#EC7662}{Y}$ .pink[when] $\color{#EC7662}{X=2}$.pink[?]
--
<br>
...
.pink[What is the marginal effect of] $\color{#EC7662}{X}$ .pink[on] $\color{#EC7662}{Y}$ .pink[when] $\color{#EC7662}{X=7}$.pink[?]
--
<br>
