...
I will post readings for each week on Canvas, do them .hi-pink[before each lecture].
...
1. .hi-blue[Prediction:] Accurately .blue[predict] or .blue[forecast] an outcome given a set of predictors. .blue[Given what we know about] $\color{#6A5ACD}{x}$.blue[, what values do we expect] $\color{#6A5ACD}{y}$ .blue[to take?]
