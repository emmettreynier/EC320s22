...
.hi-pink[Analytical problem set 1 due tomorrow (4/8) at 11:59pm], it covers the statistics review.  

.hi-pink[Computational problem set 2 is due on Monday (4/11) at 11:59pm], it is all about data wrangling in the Tidyverse, which you talked about in lab yesterday.  
...
- $\color{#EC7662}{D_i=1}$ .pink[if individual] $\color{#EC7662}{i}$ .pink[is treated].
...
- We only observe $\color{#EC7662}{y_{1,i}}$ when $\color{#EC7662}{D_{i}=1}$.
- We only observe $\color{#9370DB}{y_{0,i}}$ when $\color{#9370DB}{D_{i}=0}$.

--

**Q:** How can we estimate $\overline{\tau}$ using only $\left(\color{#EC7662}{y_{1,i}|D_i=1}\right)$ and $\left(\color{#9370DB}{y_{0,i}|D_i=0}\right)$?
...
$$
\begin{aligned}
  =&\color{#EC7662}{\mathop{Avg_n}\left( y_i\mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg_n}\left( y_i\mid D_i =0 \right)}\\
  =&\color{#EC7662}{\mathop{Avg_n}\left( y_{1i}\mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg_n}\left( y_{0i}\mid D_i =0 \right)}
\end{aligned}
$$
...
**Q.sub[2.0]:** Is $\color{#EC7662}{\mathop{Avg}\left( y_i\mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_i\mid D_i =0 \right)}$ a *good* estimator for $\overline{\tau}$?
...
$$
\begin{align}
  \tau_i = \tau = \color{#EC7662}{y_{1,i}} - \color{#9370DB}{y_{0,i}}
\end{align}
$$
...
$$
\begin{align}
   \color{#EC7662}{y_{1,i}} = \color{#9370DB}{y_{0,i}} + \tau
\end{align}
$$
...
**Q:** Is $\color{#EC7662}{\mathop{Avg}\left( y_i\mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_i\mid D_i =0 \right)}$ a *good* estimator for $\tau$?

--

Difference-in-means
--
<br> $\quad \color{#ffffff}{\Bigg|}=\color{#EC7662}{\mathop{Avg}\left( y_i\mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_i\mid D_i =0 \right)}$
--
<br> $\quad \color{#ffffff}{\Bigg|}=\color{#EC7662}{\mathop{Avg}\left( y_{1,i}\mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_{0,i}\mid D_i =0 \right)}$
--
<br> $\quad \color{#ffffff}{\Bigg|}=\color{#EC7662}{\mathop{Avg}\left( \color{#000000}{\tau \: +} \: \color{#9370DB}{y_{0,i}} \mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_{0,i}\mid D_i =0 \right)}$
--
<br> $\quad \color{#ffffff}{\Bigg|}=\tau + \color{#EC7662}{\mathop{Avg}\left(\color{#9370DB}{y_{0,i}} \mid D_i = 1 \right)} - \color{#9370DB}{\mathop{Avg}\left( y_{0,i}\mid D_i =0 \right)}$
--
...
library(pagedown)
pagedown::chrome_print("04-fun-problem.html", output = "04-fun-problem.pdf")
```
