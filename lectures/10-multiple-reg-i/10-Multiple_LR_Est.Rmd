...
.hi-pink[Midterm] scores released and solutions posted
...
.hi-pink[Analytical Problem Set 4] due tomorrow night (Friday May 6th) 
...
$$\color{#EC7662}{Y_i} = \beta_0 + \beta_1 \color{#9370DB}{X_i} + u_i.$$

**Multiple linear regression** features one .pink[outcome variable] and multiple .purple[explanatory variables]:

$$\color{#EC7662}{Y_i} = \beta_0 + \beta_1 \color{#9370DB}{X_{1i}} + \beta_2 \color{#9370DB}{X_{2i}} + \cdots + \beta_{k} \color{#9370DB}{X_{ki}} + u_i.$$
...
**One solution:** .pink[Adjusted] $\color{#EC7662}{R^2}$
...
2. .hi[No perfect collinearity:] .pink[No] $\color{#EC7662}{X}$ .pink[variable is a perfect linear combination of the others.]
...
$$\color{#EC7662}{\text{Bias} = \beta_2 \frac{\mathop{\text{Cov}}(X_{1i}, X_{2i})}{\mathop{\text{Var}}(X_{1i})}}.$$
