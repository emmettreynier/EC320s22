...
slate <- "#314f4f"
# Notes directory
dir_slides <- "Lectures/06-simple-reg-i/"
# Knitr options
opts_chunk$set(
  comment = "#>",
  fig.align = "center",
...
- **Week 3** (this week): Analytical Problem Set 2 is due Friday  
- **Week 4** (next week):
  - We'll continue with the nuts and bolts of Simple linear regression  
  - Computational Problem Set 3 (Posted this AM!)  
  - Analytical Problem Set 3  
- **Week 5**: Midterm!
  - We will review on Tuesday and in lab 
  - Test is Thursday 4/28  
  - No problem sets  
- **Week 6**: No computational HW due this Monday  
...
$$
 Y_i = \color{#EC7662}{\beta_1} + \beta_2X_i + u_i
$$
...
$$
 Y_i = \beta_1 + \color{#EC7662}{\beta_2}X_i + u_i
$$

"A one-unit increase in $X_i$ is associated with a $\color{#EC7662}{\beta_2}$-unit increase in $Y_i$."

--

Under certain (strong) assumptions about the error term, $\color{#EC7662}{\beta_2}$ is the _effect of_ $X_i$ _on_ $Y_i$.
...
$$
 Y_i = \beta_1 + \beta_2X_i + \color{#EC7662}{u_i}
$$
...
$$
\color{#EC7662}{\hat{u}_i} = \color{#EC7662}{Y_i - \hat{Y_i}}.
$$

- Sometimes called $\color{#EC7662}{e_i}$.
...
- We will perform an exercise by hand in **Analytical Problem Set 3** to understand the mechanics underlying the values we hang our hats on
