...
We considered a model where schooling has the same effect for everyone (**<font color="#EC7662">F</font>** and **<font color="#314f4f">M</font>**):
...
We will consider models that allow effects to differ by another variable (*e.g.,* by gender: **<font color="#EC7662">F</font>** and **<font color="#314f4f">M</font>**):
...
$$\color{#EC7662}{\dfrac{\partial Y}{\partial X_1} = \beta_1 + \beta_3 X_{2i}}$$
...
income %>%  
  ...
  scale_color_manual(values = c("#EC7662", "#9370DB")) +
