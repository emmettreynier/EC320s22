...
- Nick Huntington-Cline has a great [Introduction to R for Economists series on Youtube](https://youtube.com/playlist?list=PLcTBLulJV_AIuXCxr__V8XAzWZosMQIfW)! Highly recommend watching the first 10 videos (or more) in that series 
...
$$\text{OVB} = \color{#9370DB}{\hat{\beta}_1^{\text{Short}}} - \color{#EC7662}{\hat{\beta}_1^{\text{Long}}}$$
