...
$$ \Delta \log(Y) \approx \% \Delta Y $$

And since 

$$ \frac{\Delta \log(Y)}{\Delta X} = \frac{\%\Delta Y}{\Delta X} = \beta_1 $$

this implies we may interpret $\beta_1$ the percentage change in $Y$ due to a unit increase in $X$.
...
$$ \frac{\Delta Y}{\Delta X} = \beta_1 \frac{1}{X}$$

Solving for $\beta_1$ gives us 

$$ \beta_1 = \frac{\Delta Y}{\Delta X} X = \frac{\Delta Y}{\Delta X / X } = \frac{\Delta Y}{\% \Delta X}$$
In words, this implies that we may interpret $\beta_1$ as representing the change in $Y$ due to a percentage increase in $X$.
...
$$ \frac{\Delta \log(Y)}{\Delta X} = \beta_1 \frac{1}{X} $$

so that 

$$ \beta_1 = \frac{\Delta \log(Y)}{\Delta X / X} = \frac{\% \Delta Y}{\% \Delta X} $$.
